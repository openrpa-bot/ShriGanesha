  ...
  public function viewElements(FieldItemListInterface $items, $langcode): array {
    ...
    if ($has_permission) {
      ...
      if (!$within_entities_limit) {
        ...
        $warning = $this->t('Sorry, you cannot author more than @entities_limit content items with DXPR Builder on the DXPR @tier tier. Please <a href="@add_subscription" target="_blank">upgrade your account at DXPR.com</a> to create more content with DXPR Builder.', [
          '@add_subscription' => 'https://app.dxpr.com/user/me/subscription',
