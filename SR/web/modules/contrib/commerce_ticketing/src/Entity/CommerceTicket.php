...
use Drupal\commerce_ticketing\Plugin\Field\CommerceTicketingFieldItemList;
 ...
 *       "delete-multiple" = "Drupal\commerce_ticketing\Routing\DeleteMultipleRouteProvider",
 *     }
 *   },
 ...
 *   },
 *   links = {
 *     "canonical" = "/commerce_ticket/{commerce_ticket}",
 ...
 *     "admin-collection" = "/admin/commerce/tickets",
 ...
 *     "delete-multiple-form" = "/admin/commerce/tickets/delete",
 *   },
...
class CommerceTicket extends ContentEntityBase implements CommerceTicketInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['qr_code'] = BaseFieldDefinition::create('image')
      ->setLabel(t('QR Code'))
      ->setComputed(TRUE)
      ->setClass(CommerceTicketingFieldItemList::class)
      ->setDisplayConfigurable('view', TRUE)
      ->setDisplayConfigurable('form', TRUE);
    ...
    $fields['uid'] = BaseFieldDefinition::create('entity_reference')
      ->setLabel(t('Ticket Owner'))
      ->setDescription(t('The ticket owner.'))
      ->setSetting('target_type', 'user')
      ->setSetting('handler', 'default')
      ->setDefaultValueCallback('Drupal\commerce_ticketing\Entity\CommerceTicket::getCurrentUserId')
  ...
  public static function getWorkflowId(CommerceTicketInterface $ticket) {
    return CommerceTicketType::load($ticket->bundle())->getWorkflowId();
  }
